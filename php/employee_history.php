        ...
        <section class="card">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-top: 20px;">
                ...
                <div style="padding: 15px; background: var(--bg-secondary); border-radius: 8px;">
                    ...
                    <div style="font-size: 1.1rem; font-weight: 600;">$<?php echo number_format($employee['hourly_rate'], 2); ?></div>
                </div>
                <div style="padding: 15px; background: var(--bg-secondary); border-radius: 8px;">
        ...
        <section class="card">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-top: 20px;">
                <div style="padding: 15px; background: var(--bg-secondary); border-radius: 8px;">
                    ...
                    <div style="font-size: 1.3rem; font-weight: 700; color: var(--text-primary); font-family: 'DM Mono';">$<?php echo number_format($total_gross, 2); ?></div>
                    <div style="font-size: 0.85rem; color: var(--text-muted); margin-top: 4px;">Avg: $<?php echo number_format($avg_gross, 2); ?></div>
                </div>
                <div style="padding: 15px; background: var(--bg-secondary); border-radius: 8px;">
                    ...
                    <div style="font-size: 1.3rem; font-weight: 700; color: #10b981; font-family: 'DM Mono';">$<?php echo number_format($total_net, 2); ?></div>
                    <div style="font-size: 0.85rem; color: var(--text-muted); margin-top: 4px;">Avg: $<?php echo number_format($avg_net, 2); ?></div>
                </div>
                <div style="padding: 15px; background: var(--bg-secondary); border-radius: 8px;">
                    ...
                    <div style="font-size: 1.3rem; font-weight: 700; color: #f59e0b; font-family: 'DM Mono';">$<?php echo number_format($total_tax, 2); ?></div>
                    <div style="font-size: 0.85rem; color: var(--text-muted); margin-top: 4px;">Avg: $<?php echo number_format($total_tax / $record_count, 2); ?></div>
                </div>
            </div>
        </section>
        <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td class="mono">
                                    <strong>$<?php echo number_format($record['gross_income'], 2); ?></strong>
                                </td>
                                <td class="mono">
                                    <small>
                                        SSS: $<?php echo number_format($record['sss_deduction'], 2); ?><br>
                                        PH: $<?php echo number_format($record['philhealth_deduction'], 2); ?><br>
                                        PI: $<?php echo number_format($record['pagibig_deduction'], 2); ?>
                                    </small>
                                </td>
                                <td class="mono">
                                    $<?php echo number_format($record['taxable_income'], 2); ?>
                                </td>
                                <td class="mono">
                                    <span style="color: #f59e0b;">$<?php echo number_format($record['total_tax_withheld'], 2); ?></span>
                                </td>
                                <td class="mono">
                                    <strong style="color: #10b981;">$<?php echo number_format($record['net_income'], 2); ?></strong>
                                </td>
                                <td>
